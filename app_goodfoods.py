...
st.markdown('<p class="goodfoods-sub">Book tables at our restaurants across Coimbatore</p>', unsafe_allow_html=True)
...
welcome_message = "Hello! I'm here to help with your reservation at GoodFoods in Coimbatore. Ask me for recommendations or book a table at your preferred location."
